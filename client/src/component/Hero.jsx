...
import heroImage from '../assets/heroImage.png'  // adjust path if needed
...
const Hero = () => {
  return (
    ...
    >
      ...
      <p className='max-w-130 mt-2 text-sm md:text-base'>Unparalleled luxury and comfort await at the word's most exclusive hotels and resorts. Start your journey today. </p>
