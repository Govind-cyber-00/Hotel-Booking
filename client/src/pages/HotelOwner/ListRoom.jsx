      ...
      <div className='w-full max-w-3xl text-left border-gray-300 rounded-lg max-h-80 overflow-y-scroll mt-3'>
        <table className='w-full'>
          <thead className='bg-gray-50'>
            <tr>
              <th className='p-3 px-4 text-gray-800 font-medium'>Name</th>
              <th className='p-3  px-4 text-gray-800 font-medium max-sm:hidden ' >Facility</th>
              <th className='p-3 px-4 text-gray-800 font-medium text-center'>Price /night</th>
              <th className='p-3 px-4 text-gray-800 font-medium text-center'>Actions</th>
            </tr>
          </thead>
