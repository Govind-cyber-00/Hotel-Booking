...
const AddRoom = () => {
  ...
  return (
    <form >
      ...
      <button type='submit' className='bg-primary text-white py-2 px-8 rounded mt-8 hover:bg-blue-700 transition-colors duration-300 cursor-pointer'>Add Room</button>
    </form>
  )
}
