...
const MyBookings = () => {
    ...
    return (
        <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32 '>
            <Title title='My Bookings' subTitle='Easily manage Your past,current, and upcoming hotel reservations in one place. Plan Your Trips seamlessly just a few clicks ' align='left' />
                        ...
                        <div className='flex flex-col items-start justify-center pt-3'>
                            <div className='flex items-center gap-2'>
                                <div className={`h-3 w-3 rounded-full ${booking.isPaid ? "bg-green-500" : "bg-red-500"}`}></div>
                                    <p className={`text-sm mr-2 ${booking.isPaid ? "text-green-500" : "text-red-500"}`}>
